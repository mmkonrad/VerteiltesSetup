...
sudo docker-compose -H $HOME_ADDRESS:4000 up -d
...
#scale services
sudo docker-compose -H $HOME_ADDRESS:4000 scale seatoverviewservice=$1 seatmanagementservice=$1 bookingservice=$1 customermanagementservice=$1 pricingservice=3 ui=$1
